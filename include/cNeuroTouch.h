...
// Encode count to rad/deg conversions for Sensoray Board (HEDS 5540 Encoder)
...
#define ENC_CNT_PER_REV 1024					// 1024 encoder counts per revolution for the HEDS 5540
